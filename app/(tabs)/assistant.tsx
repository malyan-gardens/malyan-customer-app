...
الشركة متخصصة في المنتجات الفاخرة (ديكور ومساحات خضراء) والصيانة وتصميم المساحات.
تحدث بالعربية دائماً. كن ودوداً ومفيداً.
المنتجات المتاحة: تشكيلة بأحجام مختلفة من 35cm إلى 140cm.
...
function buildSystemPrompt(opts: {
  ...
  if (opts.from === "design") {
    extra += `\nالعميل جاء من صفحة تصميم المساحات. ساعده في اختيار الأنماط، الميزانية، والمنتجات المناسبة لمساحته.`;
  }
          ...
          {messages.length === 0 ? (
            <View style={styles.welcome}>
              ...
              <Text style={styles.welcomeText}>
                مرحباً! اسألني عن المنتجات، الصيانة، أو التصميم.
              </Text>
            </View>
          ) : null}
          {messages.map((m, i) => (
